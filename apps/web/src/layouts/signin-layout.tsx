    ...
    <main className="flex h-screen w-screen flex-col items-center justify-center">
      ...
      <div className="mx-auto flex w-full flex-col items-center justify-center space-y-6">
        <div className="flex w-96 flex-col rounded-md border border-gray-200 py-5 px-6 shadow-lg shadow-slate-200/50">
          <div className="pb-4">
            <h1 className="pb-1 text-2xl font-bold tracking-tight">Welcome to Cardinal</h1>
          </div>
          {children}
          <span className="text-xs text-slate-500">
            This is an application built for demo purposes. The information and/or accounts you use
            here will only be used for the authentication process.
          </span>
        </div>
      </div>
    </main>
