...
export const CtaButtons = () => {
  return (
    <>
      ...
      <a
        className="flex cursor-pointer items-center justify-center gap-3 rounded-md bg-slate-400/10 px-4 py-2 text-sm font-semibold text-slate-50 transition duration-150"
